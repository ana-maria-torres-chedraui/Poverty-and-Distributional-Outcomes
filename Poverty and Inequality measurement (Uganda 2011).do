...
***2011-2012 Data***
pwd 
cd "C:\Users\t_ana\OneDrive\Documents\Ana Maria\PPA\mid-term assignment\World Bank-LAPTOP-N2UDCG18-LAPTOP-N2UDCG18-LAPTOP-N2UDCG18"
use GSEC1_2011
...
* This distribution is not very representative due to outliers. From the basic summary statistics I learned that the 90% percentile of incomes boundary is 291.7 USD. As such I can attempt a histogram with an upper bound of 500 dollars income. 
...
* This first graph does not show us much, so I run it again at (y<500)
...
* I am interested in getting information based on regions, that is why I created a variable region that grouped the districts into a region category following the codes provided in: https://microdata.worldbank.org/index.php/catalog/2059/download/31321
use CSEC2b_2011
gen regions=. 
